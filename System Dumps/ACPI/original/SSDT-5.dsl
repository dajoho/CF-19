 ...
 *
 * Disassembly of iASLlJA6ud.aml, Mon Jul 24 18:49:00 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000002EC (748)
 *     Revision         0x01
 *     Checksum         0x08
 *     OEM ID           "PmRef"
...
DefinitionBlock ("", "SSDT", 1, "PmRef", "Cpu0Tst", 0x00003000)
{
    ...
    External (_PSS, UnknownObj)    // Warning: Unknown object
    ...
    Scope (\_PR.CPU0)
    {
        ...
        Method (_TSD, 0, NotSerialized)  // _TSD: Throttling State Dependencies
        {
            ...
            Store (Local1, Index (DerefOf (Index (Local0, Zero)), 0x03))
